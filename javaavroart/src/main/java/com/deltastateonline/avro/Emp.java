...
public class Emp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Emp\",\"namespace\":\"com.deltastateonline.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"salary\",\"type\":\"int\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"address\",\"type\":\"string\"}]}");
  ...
  public static com.deltastateonline.avro.Emp.Builder newBuilder() {
    return new com.deltastateonline.avro.Emp.Builder();
  }
  
  /** Creates a new Emp RecordBuilder by copying an existing Builder */
  public static com.deltastateonline.avro.Emp.Builder newBuilder(com.deltastateonline.avro.Emp.Builder other) {
    return new com.deltastateonline.avro.Emp.Builder(other);
  }
  
  /** Creates a new Emp RecordBuilder by copying an existing Emp instance */
  public static com.deltastateonline.avro.Emp.Builder newBuilder(com.deltastateonline.avro.Emp other) {
    return new com.deltastateonline.avro.Emp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Emp>
    ...
    private Builder() {
      super(com.deltastateonline.avro.Emp.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.deltastateonline.avro.Emp.Builder other) {
      super(other);
    ...
    private Builder(com.deltastateonline.avro.Emp other) {
            super(com.deltastateonline.avro.Emp.SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'name' field */
    public com.deltastateonline.avro.Emp.Builder setName(java.lang.CharSequence value) {
    ...
    public com.deltastateonline.avro.Emp.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'id' field */
    public com.deltastateonline.avro.Emp.Builder setId(int value) {
    ...
    public com.deltastateonline.avro.Emp.Builder clearId() {
    ...
    /** Sets the value of the 'salary' field */
    public com.deltastateonline.avro.Emp.Builder setSalary(int value) {
    ...
    public com.deltastateonline.avro.Emp.Builder clearSalary() {
    ...
    /** Sets the value of the 'age' field */
    public com.deltastateonline.avro.Emp.Builder setAge(int value) {
    ...
    public com.deltastateonline.avro.Emp.Builder clearAge() {
    ...
    /** Sets the value of the 'address' field */
    public com.deltastateonline.avro.Emp.Builder setAddress(java.lang.CharSequence value) {
    ...
    public com.deltastateonline.avro.Emp.Builder clearAddress() {
      address = null;
